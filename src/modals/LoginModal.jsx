       ...
       <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-300">
          <div className={`w-full max-w-md p-8 rounded-3xl shadow-2xl relative overflow-hidden ${isDarkMode ? 'bg-[#1a1a2e] border border-white/10' : 'bg-white'}`}>
             ...
             <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-12 h-12 rounded-2xl bg-linear-to-tr from-pink-500 to-violet-500 mb-4 shadow-lg shadow-pink-500/30"><Sparkles className="w-6 h-6 text-white" /></div>
